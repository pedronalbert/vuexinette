...
var buildActions = function buildActions(entity, opts) {
  return {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.prev = 3;
                _context.next = 6;
                return entity.api.get(id, params, _extends({}, (0, _lodash.pick)(opts, ['action'])));
...
exports.default = function () {
  ...
  return {
    state: initState,
    mutations: mutations,
    actions: buildActions(opts.entity, (0, _lodash.omit)(opts, ['entity'])),
